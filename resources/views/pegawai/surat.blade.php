                    ...
                    @forelse ($surat as $s)
                        <tr>
                            ...
                            <td class="d-flex gap-2">
                                {{-- Edit: hanya jika masih menunggu --}}
                                ...
                                <a href="{{ route('pegawai.surat.pdf', $s->id) }}" class="btn btn-link p-0 m-0" title="Cetak PDF">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <label>Tujuan</label>
                            <input type="text" name="tujuan" class="form-control" placeholder="Kota/Instansi Tujuan" required>
                        </div>
                        <div class="col-12">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="alat_transportasi" class="form-control" placeholder="Mobil Dinas/Kereta Api/dll">
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="number" step="0.01" name="transportasi" class="form-control" value="0">
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <select name="pimpinan_id" class="form-control" required>
                                @foreach ($listPimpinan as $p)
                                    <option value="{{ $p->id }}" @selected($s->pimpinan_id == $p->id)>{{ $p->name }} ({{ $p->jabatan }})</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-md-3">
                            ...
                            <input type="date" name="tanggal_berangkat" class="form-control"
                                   value="{{ \Carbon\Carbon::parse($s->tanggal_berangkat)->format('Y-m-d') }}" required>
                        </div>
                        <div class="col-md-3">
                            <label>Tanggal Kembali</label>
                            <input type="date" name="tanggal_kembali" class="form-control"
                                   value="{{ \Carbon\Carbon::parse($s->tanggal_kembali)->format('Y-m-d') }}" required>
                        </div>
                        ...
                        <div class="col-md-6">
                            <label>Alat Transportasi</label>
                            <input type="text" name="alat_transportasi" class="form-control" value="{{ $s->alat_transportasi }}">
                        </div>
