...
@section('content')
@php
    // inisial untuk avatar hero
    $displayName = auth()->user()->name ?? 'Pegawai';
...
<style>
    ...
    .text-muted-why{ color:#94a3b8; font-style: italic; }
</style>
        ...
        <div class="profile-hero mb-4">
            <div class="row align-items-center g-3">
                ...
                <div class="col">
                    ...
                    <div class="hero-sub">Selamat datang kembali 👋</div>
                    <div class="mt-2">
                        <span class="chip"><i class="uil uil-user"></i> Pegawai</span>
                        <span class="chip"><i class="uil uil-file-plus-alt"></i> Kelola SPD dengan mudah</span>
                    </div>
                </div>
                <div class="col-12 col-md-auto text-md-end mt-2 mt-md-0">
                    <a href="{{ route('pegawai.surat.index') }}" class="btn btn-light">
                        <i class="uil uil-file-plus-alt"></i> Buat / Kelola Surat
                    </a>
                </div>
            </div>
        </div>
                    ...
                    <tbody>
                        @forelse ($terbaru as $s)
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    {{-- Tombol Cetak hanya tampil jika status sudah diterima --}}
                                    ...
                                    @else
                                        <span class="text-muted-why small me-2">Menunggu persetujuan</span>
                                    @endif
                                    <a href="{{ route('pegawai.surat.index') }}" class="btn btn-sm btn-soft">
                                        Detail
                                    </a>
                                </td>
                            </tr>
