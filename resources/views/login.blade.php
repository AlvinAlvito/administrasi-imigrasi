                    ...
                    <div class="modal-dialog">
                        <form method="POST" action="/" class="modal-content">
                            ...
                            <div class="modal-header">
                                <h5 class="modal-title">Login Sistem Surat Perjalanan Dinas</h5>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="username" id="nip" class="form-control"
                                        placeholder="admin atau NIP Pegawai/Pimpinan" required>
                                </div>
                                <div class="mb-3">
                                ...
                                <small class="text-muted">
                                    <ul class="mt-2 mb-0 ps-3">
                                        <li>Admin login: <strong>admin / 123</strong></li>
                                        <li>Pegawai & Pimpinan login: gunakan <strong>NIP</strong> dan password
                                            masing-masing</li>
                                    </ul>
                                </small>
                            </div>
