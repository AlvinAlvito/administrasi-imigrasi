            ...
            <div class="activity">
                ...
                <table id="datatable" class="table table-hover table-striped align-middle">
                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($prof && $prof->tanda_tangan)
                                        <img src="{{ asset($prof->tanda_tangan) }}" alt="TTD" width="80">
                                    @else
                                        -
                                    @endif
                        ...
                        @empty
                            <tr>
                                <td colspan="11" class="text-center">Belum ada akun pimpinan.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <label>Nama</label>
                                <input type="text" name="name" class="form-control" value="BARANDARU WIDYARTO"
                                    required>
                            </div>
                            <div class="col-md-6">
                                <label>NIP</label>
