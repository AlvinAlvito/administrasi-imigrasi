                    ...
                    <tbody>
                        @forelse ($surat as $s)
                            <tr>
                                ...
                                <td>
                                    {{-- Tombol cetak selalu tersedia untuk Admin --}}
                                    <a href="{{ route('admin.surat.pdf', $s->id) }}"
                                        class="btn btn-sm btn-outline-primary me-1">
                                        <i class="uil uil-file-download"></i> Cetak
                                    </a>

                                    {{-- Jika sudah ada file tersimpan, tampilkan juga "Lihat" --}}
                                    @if ($s->file_surat_pdf)
                                        <a href="{{ asset($s->file_surat_pdf) }}" target="_blank"
