...
<style>
    /* ====== Profil Polishing (kembaran gaya pegawai) ====== */
    .profile-hero{
    ...
    .ttd-box img{ max-width:100%; max-height:160px; object-fit:contain; }
    .muted{ color:#64748b; }
            ...
            <div class="row align-items-center g-3">
                ...
                <div class="col-12 col-md-auto text-md-end mt-2 mt-md-0">
                    <div class="kicker">
                        ...
                        <div class="stat"><i class="uil uil-rocket"></i> {{ $p->eselon ?? '—' }}</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row g-4">
            <div class="col-lg-6">
                <div class="card p-3 h-100">
                    ...
                    <div class="d-flex gap-2 flex-wrap">
                        <a href="{{ route('pimpinan.surat.index') }}" class="btn btn-primary">
                            <i class="uil uil-check-circle"></i> Verifikasi Surat
                        </a>
                        <a href="{{ route('pimpinan.index') }}" class="btn btn-soft">
            ...
            <div class="col-lg-6">
                <div class="card p-3 h-100">
                    ...
                    <div class="section-title"><i class="uil uil-pen"></i> Tanda Tangan</div>
                    <div class="ttd-box">
                        @if($ttdUrl)
                            <img src="{{ $ttdUrl }}" alt="Tanda Tangan Pimpinan">
                        @else
                            <div class="muted">Belum ada tanda tangan yang diunggah.</div>
                        @endif
                    </div>
                </div>
            </div>
